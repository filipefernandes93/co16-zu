// $Id: postfix_writer.h,v 1.16 2016/05/20 04:55:37 ist173253 Exp $ -*- c++ -*-
...
namespace zu {
  ...
  class postfix_writer: public basic_ast_visitor {
    ...
    std::string _current_function_end_label;//

	std::vector<int> _end_for_labels;
	std::vector<int> _incr_for_labels;

    int _lbl;
int _last_var_addr = 0;


  public:
    postfix_writer(std::shared_ptr<cdk::compiler> compiler, cdk::symbol_table<zu::symbol> &symtab, cdk::basic_postfix_emitter &pf) :
  ...
  private:
	...
	bool is_same_type (basic_type *type1, basic_type *type2){
